...
VER=9.3.4
VERHUMAN=$VER
PKG=omniti/database/postgresql-${VER//./}/auto_explain
DOWNLOADDIR=postgres
MODULE=auto_explain
CONTRIBDIR=contrib/$MODULE
SUMMARY="$PROG $MODULE - Automatic Logging of the Plans of Slow-Running Queries for PostgreSQL $VER"
DESC="$SUMMARY"
