...
VERHUMAN=$VER
PHPVER=53
PKG=omniti/library/php-$PHPVER/dtrace
SUMMARY="A Solaris Dtrace provider"
DESC="Allows dtrace to instrument PHP"

BUILD_DEPENDS_IPS="omniti/runtime/php-$PHPVER"
...
init
download_source $PROG dtrace $VER
patch_source
prep_build
build
make_isa_stub
