...
PROG=node-policyfile
VER=0.0.5
PKG=omniti/runtime/nodejs/node-policyfile
SUMMARY="A simple Flash Policy File Server for node"
DESC="$SUMMARY"

REPOS=https://github.com/3rd-Eden/FlashPolicyFileServer
GIT=/usr/bin/git
...
make_install() {
    ...
    logcmd mv $DESTDIR/opt/omni/lib/node/$PROG-$VER/lib $DESTDIR/opt/omni/lib/node/policyfile
